...
public class CareFlashiHelpCalendarPage extends Page
{
        public CareFlashiHelpCalendarPage()
        {
            super();
        ...
        public CareFlashCalendarEntry clickNewRequest()
        {
            driver.findElement(By.id("ui-id-3")).click();
            return new CareFlashCalendarEntry();
        }
}
